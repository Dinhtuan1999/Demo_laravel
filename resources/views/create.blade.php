            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        <form method="POST" action="{{ route('auction.day.store') }}" enctype="multipart/form-data"
                              id="formCreateAuctionDay">
                            {{ csrf_field() }}
                                    ...
                                    <select class="js-example-basic-single col-sm-12 category_id" name="category_id">
                                        ...
                                        @if(!is_null($categories))
                                            @foreach($categories as $key =>$value)
                                                <option
                                                    {{ old('category_id') ==  $value->id ? 'selected' : ''}} value="{{ $value['id'] }}">{{ $value['title'] }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control " type="date" id="start_date" min="" name="start_date"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-radio m-b-30">
                                        <div class="radio radiofill radio-default radio-inline">
                                            <label>
                                                <input type="radio" id="reply_negotiation" name="reply_negotiation"
                                                       value="0" checked>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-xs-12">
                                    <button type="button" style="float:right"
                                            class="btn waves-effect waves-light btn-info btn-square button_submit_auction">
                                        保存
                                    </button>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        $('.button_submit_auction').click(function () {
            // $.LoadingOverlay("show");
            let data_box = $('#data_box_num').data('array')
            let start_date = $('#start_date').val();
            let title = $('.fill').val();
            let category_id = $('.category_id').val();
            let reply_negotiation = '';
